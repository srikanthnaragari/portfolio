...
const About = () => {
  ...
  return (
    <>
      ...
      >
        I'm a skilled digital marketer with experience in SEO, social media, 
        Google Ads, and email marketing. I specialize in crafting data-driven 
        strategies using tools like Meta Ads, Google Analytics, and marketing 
        automation platforms. I'm a quick learner and work closely with clients 
        to deliver impactful, scalable, and results-oriented campaigns that drive real growth. 
        Let's work together to bring your brand to life online!
      </motion.p>
      <div

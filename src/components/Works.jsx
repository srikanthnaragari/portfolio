  ...
  return (
    <>
      ...
      <div className="flex w-full">
        ...
        >
          The following campaigns and initiatives showcase my digital marketing skills and experience through real-world examples. 
          Each project is briefly described, highlighting strategies used, performance metrics, and outcomes achieved. 
          They reflect my ability to craft targeted campaigns, leverage diverse digital platforms, analyze data effectively, 
